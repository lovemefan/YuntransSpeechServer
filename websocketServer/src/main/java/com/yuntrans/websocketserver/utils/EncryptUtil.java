...
public class EncryptUtil {
     ...
     */
    public static String HmacSHA256Encrypt(String encryptText, String encryptKey) throws SignatureException {
        byte[] rawHmac = null;
        try {
    ...
    public static void main(String[] args) {
        ...
        try {
            signature = EncryptUtil.HmacSHA256Encrypt(signatureOrigin, "2kCPFNALTgPbi9GIzOTCw1bPkvsjhwI9gsMKoRocKW8=");
