...
public class WebsocketController {
    ...
    public String test(HttpServletRequest request) throws Exception {
        mqSender.sendChineseMessage(new SpeechBody("zh", "wav", AudioStatus.START, "" + System.currentTimeMillis()/100, "something"), null);
    ...
    public String testTag(HttpServletRequest request) throws Exception {
        mqSender.sendChineseMessage(new SpeechBody("zh", "wav", AudioStatus.START, "" + System.currentTimeMillis()/100, "something with tag"), "zh0456789");
        System.out.println("发送了一条消息");
        return "ok";
    }
}
