 ...
 */
package com.yuntrans.rocketmq.console.service.client;
...
public class MQAdminExtImpl implements MQAdminExt {
    ...
    @Override
    public void deleteSubscriptionGroup(String s, String s1, boolean b) throws RemotingException, MQBrokerException, InterruptedException, MQClientException {
    ...
    public void start() throws MQClientException {
        throw new IllegalStateException("thisMethod is deprecated.use com.yuntrans.rocketmq.console.aspect.admin.MQAdminAspect instead of this");
    }
